...
client.on("message", message => {
 ...
 if (message.content === "SR!help") {
  ...
  const embed = new Discord.RichEmbed()
      ...
      .addField("『@! AG ƤΘƘėℜ ƊȤ`₉₅☯#1624』『مصمم البوت』", true)
      
      .addField("『SR!help1』😘『اذا تبي جميع الاوامر مع اوامر اضافية』😵", true)
      
	    .addField("『SR!help2』👻『اذا تبي الاوامر العامة』😳", true)
	    
      .addField("『SR!help3』😮『اذا تبي  الاوامر الادارية』🤒", true)
...
client.on('message', message => {
   if (message.content === "SR!roll 1") {
  message.channel.sendMessage(Math.floor(Math.random() * 25));
    }
});
 
client.on('message', message => {
   if (message.content === "SR!roll 2") {
  message.channel.sendMessage(Math.floor(Math.random() * 50));
    }
});
 
client.on('message', message => {
   if (message.content === "SR!roll 3") {
  message.channel.sendMessage(Math.floor(Math.random() * 75));
    }
});
 
client.on('message', message => {
   if (message.content === "SR!roll 4") {
...
const secreT = [
 ...
 client.on('message', message => {
   if (message.content.startsWith("SRخواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
...
💎SR!servers 『علشان تشوف البوت بكم سيرفر اون لاين 』  

💎SR!bot 『لمعرف البوت بكم سيرفر』

💎SR!date 『لمعرفه التاريخ』

💎SR!ping 『لمعرفه سرعه البوت』

💎SR!members 『معلومات عن الاعضاء』

💎SR!embed 『خاصيه غرد لكن بغير طريقه』

💎SR!say 『لي يكرر الكلام الذي تقوله』

💎SR!animal  『كود لي اضهار صور  للحيوانات』

● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 

👑『اوامر ادارية』👑

👑SR!rooms 『لمعرفه عدد رومات السيرفر』

👑SR!ban 『لتعطي شخص باند』

👑SR!kick 『لتعطي شخص كيك』

👑SR!clear 『لمسح الشات برقم』

👑SR!edit  『لتعديل رساله 』

👑SR!ct  مـلاحظه: الاسم انت تختاره『لي انشاء روم كتابي』

👑SR!cv  مـلاحظه: الاسم انت تختاره『لي انشاء روم صوتي』

👑SR!delet  『كـود يحذف الـروم سواء صوتي او كتابي』

● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 

🎲『القرعة』🎲

🎲SR!roll 1   『القرعة من 1 الى 25』

🎲SR!roll 2   『القرعة من 1 الى 50』

🎲SR!roll 3   『القرعة من 1 الى 75』

🎲SR!roll 4   『القرعة من 1 الى 100』
...
🎴SR!avatar 『لي عرض صورتك او صوره اي شخص』

🎴SR!image 『لي عرض صوره السيرفر』
...
client.on('message', (message) => {
    if (message.content.startsWith('SR!ban ')) {
...
client.on('ready', () => {
   client.user.setGame(" SR!help | SR!invite ");
}); 
...
client.on('message', message => {
  if (true) {
if (message.content === 'SR!support') {
      message.author.send(' |https://discord.gg/gqRamSc لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === 'SR!invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=467341271803887616&permissions=8&scope=bot ').catch(e => console.log(e.stack));
...
client.on('message', message => {
            if(!message.channel.guild) return;
let args = message.content.split(' ').slice(1).join(' ');
if (message.content.startsWith('SR!bc-users')){
...
client.on('message', message=>{
    if (message.content ==='SR!add-colors'){
    ...
    if (message.content === 'SR!de-colors'){
                if (message.channel.guild){
            if (message.member.hasPermission('MANAGE_ROLES')){
                setInterval(function(){})
                  let count = 0;
