...
client.on('message', message => {
  ...
  .addField("** تم تطوير وبرمجه البوت من قبل :wrench: **","**™ » !SR |ƤΘƘėℜ ƊȤ₉₅☯!#1624 **")
...
client.on('message', message => {
            if (message.content.startsWith("sr!القوانين")) {
     let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)
...
client.on('message', message => {
    if (message.content.startsWith('sr!clearr')) {
...
client.on('message', message => {
            if (message.content.startsWith("sr!botinfo")) {
     let embed = new Discord.RichEmbed()
...
if (message.content === 'sr!help') {
      ...
      .addField("**:video_game: اوامر تشغيل الالعاب**","** **")
        .addField("**sr!hack **","**لعبه تهكير اصدقاءك للمزاح**")
        .addField("**sr!pubg **","**لعبه اسئله باتل جرواند ببجي**")
        .addField("**sr!e**","**لكتابه اي اسم بلاايموجي**")
.setColor('RANDOM')
...
if (message.content === 'sr!help') {
      ...
      .addField("**:globe_with_meridians: الأوامر العامه**","** **")
       .addField("**sr!قوانين**","**لـــ معرفة قوانين السيرفر**")
        .addField("**sr!id **","**معلومات حسابك**")
        .addField("**sr!botinfo **","**معلومات البوت**")
        .addField("**sr!ping **","**سرعه اتصال البوت**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**sr!bc  :mega:**","**لـ البرودكاست**")
      .addField("**sr!clear :octagonal_sign:**","**لـ مسح الشات**")
      .addField("**sr!kick  :outbox_tray:**","**لـ طرد عضو**")
      .addField("**sr!ban  :outbox_tray:**","**لـ حظر عضو**")
        .addField("**sr!say**","**لتكلم بصفه البوت**")
        .addField("**sr!cv**","**عمل روم صوتي**")
        .addField("**sr!cct**","**عمل روم صوتي**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
client.on('message' , message => {
if (message.content === 'sr!owner') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
...
const pubg = [
   ...
   client.on('message', message => {
       if (message.author.bot) return;
 if (message.content.startsWith('sr!pubg')) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
  var client= new Discord.RichEmbed()
...
client.on('message', message => {
    if (message.content.startsWith("sr!hack")) {
...
client.on("message", (message) => {
    if (message.content.startsWith("sr!cct")) {
                if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
            let args = message.content.split(" ").slice(1);
