...
message.channel.sendEmbed(cat);
 ...
 .addField('لعبه كت تويت' ,
  ...
  message.channel.sendEmbed(embed);
  console.log('[355783597480738816] Send By: ' + message.author.username)
    }
});
 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=467341271803887616&permissions=8&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discordapp.com/api/oauth2/authorize?client_id=467341271803887616&permissions=8&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', message => {
  ...
  .setAuthor(`SR!KICKED!`, user.displayAvatarURL)
  .setColor("RANDOM")
  .setTimestamp()
...
client.on('message', message => {
  ...
  .setAuthor(`SR!BANNED!`, user.displayAvatarURL)
  .setColor("RANDOM")
  .setTimestamp()
  .addField("**User:**",  '**[ ' + `${user.tag}` + ' ]**')
  .addField("**By:**", '**[ ' + `${message.author.tag}` + ' ]**')
...
message.member.addRole(message.guild.roles.find("name", "100"));
  ...
  if (message.content === 'SR!colors') {
      if (!message.channel.guild) return;
    message.channel.sendFile('https://pbs.twimg.com/profile_images/740238230747029505/eIMDsHZZ_400x400.jpg');
  }
