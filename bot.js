...
.addField('     **SR!bot** ' ,' **معلومات البوت** ')
.addField('     **SR!id**  ' ,' **اي دي حسابك** ')
.addField('     **SR!ser-av** ' , ' **صورة اليرفر**')
.addField('     **SR!mute** ' ,' **اعطاء ميوت*')
.addField('     **SR!unmute** ' ,' ** فك الميوت** ')
.addField('     **SR!avatar** ' , ' **صورتك في الدسكورد أو صورة الشخص المذكور**')
.addField('     **SR!member** ' , ' **معلومات العضو**')
.addField('     **SR!server** ' ,' **معلومات السيرفر** ')
.addField('     **SR!dt** ' ,' **اظهالر التاريخ** ')
.addField('     **SR!ban** ' ,' **للباند** ')
.addField('     **SR!kick ** ' ,' **للطرد  ** ')
.addField('     **SR!bc** ' ,' **للبرودكاست ** ')
.addField('     **SR!clear** ' ,' **لـ مسح الشات** ')
.addField('     **SR!mutech** ' , ' **لقفل الشات** ')
.addField('     **SR!unmutech ** ' ,' **لفتح الشات** ')
.setColor('RANDOM')
...
client.on('guildMemberAdd', member => {
    ...
    .setColor('GREEN')
    .setFooter('SR Bot', 'https://cdn.discordapp.com/avatars/467341271803887616/a96dd4c0dffaa535dfad1d698fd177c2.png?size=128&quot')
...
client.on('message', message => {
       ...
       if(message.content === prefix + "SR!mutech") {
                           if(!message.channel.guild) return message.reply('** This command only for servers**');
...
//viper
    if(message.content === prefix + "SR!unmutech") {
                        if(!message.channel.guild) return message.reply('** This command only for servers**');
